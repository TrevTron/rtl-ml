...
| **Raspberry Pi 5** | BCM2712 (4-core) | 8GB | 122ms | $200 (May 2026) | ✅ **Recommended** |
...
**Bottom line:** Both Nova and Pi 5 deliver real-time performance. Pi 5 is recommended due to better availability and massive community support. (Pricing volatile as of May 2026 — Pi 5 8GB currently ~$200.)
...
**17 numerical features** extracted from each sample:

| Category | Features | What They Capture |
|----------|----------|-------------------|
| **Power** (4) | mean, std, max, min | Signal strength characteristics |
...
# Array of 17 numbers ready for ML model
```
